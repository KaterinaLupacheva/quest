...
export default function Task({ price, idx, onClick }: TaskProps) {
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="w-60 h-60 flex flex-col justify-evenly max-w-sm p-6 border rounded-lg shadow hover:bg-gray-100 bg-gray-800 border-gray-700 hover:bg-gray-700 text-white text-center">
